...
#'
clean_batch_df <- function(data_info, autocleans = FALSE, filters = TRUE, tz_in = "UTC", tz_out = "UTC") {
  data_sets <- list()
...
#'
clean_store_batch <- function(data_info, autocleans=FALSE, filters=TRUE, elev, get_slope, get_aspect, min_lat, max_lat, min_long, max_long, tz_in = "UTC", tz_out = "UTC") {
